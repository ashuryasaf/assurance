  ...
  return (
    <div style={{ minHeight: '100vh', background: 'white' }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <div style={{ color: 'white', fontWeight: '800', fontSize: '20px', lineHeight: '1.2' }}>אשורי</div>
              <div style={{ color: '#c9a227', fontSize: '12px', fontWeight: '600' }}>סוכנות לביטוח</div>
            </div>
          </div>
      ...
      <section style={{
        ...
        <div style={{
          position: 'absolute', bottom: '-50px', insetInlineStart: '-80px',
          width: '400px', height: '400px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(52,104,196,0.2) 0%, transparent 70%)',
        }} />
      ...
      <section style={{
        ...
        <div style={{
          ...
          {stats.map(stat => (
            <div key={stat.label}>
              <div style={{ color: '#c9a227', fontSize: '40px', fontWeight: '800', marginBottom: '4px' }}>
                {stat.value}
              </div>
      ...
      <section id="services" style={{ padding: '80px 40px', background: '#f5f7fc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {features.map(f => (
              <div key={f.key} className="card animate-fadeIn" style={{
                padding: '32px',
              ...
              >
                ...
                <h3 style={{ fontSize: '19px', fontWeight: '700', color: '#1e3a6e', marginBottom: '10px' }}>
                  {t(`feature${f.key}Title`)}
                </h3>
                <p style={{ color: '#6b7a9a', lineHeight: '1.6' }}>
      ...
      <section id="about" style={{ padding: '80px 40px', background: 'white' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '36px', fontWeight: '800', color: '#1e3a6e', marginBottom: '12px' }}>
              שירותי ממשלה ישראליים
            </h2>
            <p style={{ color: '#6b7a9a', fontSize: '17px' }}>
              חיבור ישיר לכל השירותים הפיננסיים החשובים שלך
            </p>
          </div>
          <div style={{
            display: 'grid',
            ...
            {[
              { icon: '🏔️', title: t('harBituach'), desc: t('harBituachDesc'), color: '#1e3a6e', url: 'https://www.gov.il/he/departments/insurance-supervision' },
              { icon: '💰', title: t('harHakesef'), desc: t('harHakesefDesc'), color: '#2451a0', url: 'https://www.gov.il/he/departments/insurance-supervision' },
              { icon: '🏦', title: t('maslakaHapensionit'), desc: t('maslakaDesc'), color: '#1a3060', url: 'https://www.pension.org.il' },
            ].map(s => (
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '17px', marginBottom: '32px' }}>
            הצטרף לאלפי לקוחות שכבר נהנים מניהול ביטוח חכם
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/register" style={{
              background: 'linear-gradient(135deg, #c9a227, #a87c1a)',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                ...
                <div>
                  ...
                  <div style={{ color: '#c9a227', fontSize: '12px' }}>סוכנות לביטוח</div>
                </div>
              </div>
            ...
            <div>
              ...
              {['policies', 'documents', 'marketplace', 'reports', 'esign'].map(k => (
                <div key={k} style={{ marginBottom: '8px' }}>
                  <Link href={`/dashboard/${k}`} style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none', fontSize: '14px' }}>
                    {t(k)}
                  </Link>
                </div>
              ))}
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', marginBottom: '8px' }}>✉️ info@ashuri.co.il</div>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '13px' }}>© {new Date().getFullYear()} אשורי סוכנות לביטוח. {t('allRightsReserved')}</span>
            <LanguageSwitcher />
          </div>
        </div>
      </footer>
